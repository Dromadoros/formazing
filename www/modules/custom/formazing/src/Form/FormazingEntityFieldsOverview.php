...
use Drupal\formazing\Entity\TextFieldFormazingEntity;
...
class FormazingEntityFieldsOverview extends FormBase
{
     ...
     *   An associative array containing the current state of the form.
     *
     * @param string $formazing_entity
     *   A string containing the id of the parent entity form.
     *
     * @return array
     */
    public function buildForm(array $form, FormStateInterface $form_state, $formazing_entity = NULL)
    {
        $query = \Drupal::entityQuery('field_formazing_entity')
        ->condition('formazing_id', $formazing_entity);
        $ids = $query->execute();
        ...
        uasort($elements, [$this, 'orderWeight']);
    ...
    /**
     * @param FieldFormazingEntity $a
     * @param FieldFormazingEntity $b
     * @return int
     */
    private function orderWeight($a, $b)
    {
