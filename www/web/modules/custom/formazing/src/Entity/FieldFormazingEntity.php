 ...
 *     "views_data" = "Drupal\formazing\Entity\FieldFormazingEntityViewsData",
 *
 *     "form" = {
 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/structure/field_formazing_entity/{field_formazing_entity}",
 *     "add-form" = "/admin/structure/field_formazing_entity/add",
 *     "edit-form" = "/admin/structure/field_formazing_entity/{field_formazing_entity}/edit",
 *     "delete-form" = "/admin/structure/field_formazing_entity/{field_formazing_entity}/delete",
 *     "collection" = "/admin/structure/field_formazing_entity",
 *   },
 *   field_ui_base_route = "field_formazing_entity.settings"
 * )
 */
class FieldFormazingEntity extends ContentEntityBase implements FieldFormazingEntityInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ...
      $fields['placeholder'] = BaseFieldDefinition::create('string')
        ...
        ->setDisplayConfigurable('form', TRUE)
        ->setDisplayConfigurable('view', TRUE);$fields['name'] = BaseFieldDefinition::create('string')
        ->setLabel(t('Name'))
        ->setDescription(t('The name of the Field formazing entity entity.'))
        ->setSettings([
          'max_length' => 50,
